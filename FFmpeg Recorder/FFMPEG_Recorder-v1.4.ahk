...
label1:
Progress, off
Run, %Recorder% %Uagent% %Referer% -i %Link% -c copy %PathFile%
ExitApp
label2:
Progress, off
Run, %comspec% /c "%Recorder% %Uagent% %Referer% -i %Link% -c copy %PathFile% -c copy -f mpegts - | %Mplayer% -fs %Drawtext% -autoexit -"
ExitApp
