...
label1:
Progress, off
Run, %Recorder% %Uagent% %Referer% -i %Link% %ffcommand% %PathFile%
ExitApp
label2:
Progress, off
Run, %comspec% /c "%Recorder% %Uagent% %Referer% -i %Link% %ffcommand% %PathFile% -c copy -f mpegts - | %Mplayer% -fs %Drawtext% -autoexit -"
ExitApp
